...
flanker_df_acc_congruent = flanker_df_acc_congruent %>% 
  select(-partic_cond_mean_errors) %>%
...
flanker_df_acc_switch = flanker_df_acc_switch %>% 
  select(-partic_switch_mean_errors) %>%
...
```{r}
flanker_df_acc_nogo$overall_mean_nogo_effect = 
  mean(flanker_df_acc_nogo$nogo_effect)
flanker_df_acc_nogo$overall_sd_nogo_effect = 
  sd(flanker_df_acc_nogo$nogo_effect)
```
...
full_flanker_df = full_join(full_flanker_df, flanker_df_acc_nogo)
